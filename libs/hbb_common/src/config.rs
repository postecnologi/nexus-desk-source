...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("NEXUS Desk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["67.205.136.228"];
pub const RS_PUB_KEY: &str = "IJ9qI3bOzuDsaDrP6hMOAJHLgQw3dxRmFaRP0ZzI1Fw=";
